// app/works/Fluid_sim_gpu/core/App.ts
// Orchestrator: animation loop, pointer events, dye injection (GPU-based, CPU-matched params)
...
export class App {
  ...
  getParams(): Record<string, number> {
    return {
      ...
      drag: this.fluid.velocityDissipation,
      viscosity: this.fluid.diffusion,
      saturation: this.fluid.saturation,
      brightness: this.fluid.brightness,
    };
  }

  setParam(key: string, value: number): void {
    switch (key) {
      case "vorticity": this.fluid.curl = value; break;
      case "dyeDecay": this.fluid.densityDissipation = value; break;
      case "force": this.forceMultiplier = value; break;
      case "drag": this.fluid.velocityDissipation = value; break;
      case "viscosity": this.fluid.diffusion = value; break;
      case "saturation": this.fluid.saturation = value; break;
      case "brightness": this.fluid.brightness = value; break;
    }
  }
