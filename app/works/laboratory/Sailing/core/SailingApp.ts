...
void main(){
 ...
 float wakeLightAngleA=radians(uLightDirection);
 float wakeLightAngleB=radians(90.0+uLightDirection);
 float wakeLightAngleC=radians(180.0+uLightDirection);
 float wakeLightAngleD=radians(270.0+uLightDirection);
 vec3 wakeLightA=normalize(vec3(cos(wakeLightAngleA),.88,sin(wakeLightAngleA)));
 vec3 wakeLightB=normalize(vec3(cos(wakeLightAngleB),.88,sin(wakeLightAngleB)));
 vec3 wakeLightC=normalize(vec3(cos(wakeLightAngleC),.88,sin(wakeLightAngleC)));
 vec3 wakeLightD=normalize(vec3(cos(wakeLightAngleD),.88,sin(wakeLightAngleD)));
 ...
 float wakeReflectionA=max(dot(reflect(-wakeLightA,normal),viewDir),0.0);
 float wakeReflectionB=max(dot(reflect(-wakeLightB,normal),viewDir),0.0);
 float wakeReflectionC=max(dot(reflect(-wakeLightC,normal),viewDir),0.0);
 float wakeReflectionD=max(dot(reflect(-wakeLightD,normal),viewDir),0.0);
 float wakeSpec=pow(wakeReflectionA,72.0)+pow(wakeReflectionB,72.0)+pow(wakeReflectionC,72.0)+pow(wakeReflectionD,72.0);
 float spec=mix(pow(reflection,72.0),wakeSpec,uFoamScreenSpace)*mix(1.0,.06,uFoamScreenSpace);
