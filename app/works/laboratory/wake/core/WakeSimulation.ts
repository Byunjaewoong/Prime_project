...
void main() {
  ...
  float bow = gaussian(local, vec2(0.0, 0.016), vec2(0.010, 0.022));
  float sternL = gaussian(local, vec2(-0.011, -0.020), vec2(0.012, 0.030));
  float sternR = gaussian(local, vec2(0.011, -0.020), vec2(0.012, 0.030));
...
void main(){
 ...
 float bow=gaussian(local,vec2(0.0,0.018),vec2(0.011,0.020));
 float sternL=gaussian(local,vec2(-0.013,-0.024),vec2(0.012,0.030));
 float sternR=gaussian(local,vec2(0.013,-0.024),vec2(0.012,0.030));
 float hull=gaussian(local,vec2(0.0,-0.002),vec2(0.010,0.030));
