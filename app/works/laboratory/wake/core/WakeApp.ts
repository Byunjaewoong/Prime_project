...
void main(){
 ...
 float wakeLightAngleA=radians(230.0+uLightDirection);
 float wakeLightAngleB=radians(30.0+uLightDirection);
 ...
 float wakeSpec=pow(wakeReflectionA,72.0)+pow(wakeReflectionB,72.0);
