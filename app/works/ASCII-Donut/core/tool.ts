...
export class Calculate {
  ...
  static distanceLineToPoint(
    ...
    const numer = expo_x ** 2 + expo_y ** 2 + expo_z ** 2;
    const denom = x_polar ** 2 + y_polar ** 2 + z_polar ** 2;
  ...
  static axisRotation(
    ...
    arr1[0][0] = Math.cos(angle) + (1 - Math.cos(angle)) * axisX ** 2;
    ...
    arr1[1][1] = Math.cos(angle) + (1 - Math.cos(angle)) * axisY ** 2;
    ...
    arr1[2][2] = Math.cos(angle) + (1 - Math.cos(angle)) * axisZ ** 2;
  ...
  static perspectiveLength(
    ...
    const windowLength = (sightdistance / distance) * realLength;
    return windowLength;
  }
