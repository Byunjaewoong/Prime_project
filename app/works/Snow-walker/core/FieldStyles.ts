...
export const FIELD_STYLES = [
  { name: "Snow", ground: 0xffffff, background: 0xffffff, fog: 0.035, ambient: 1, sun: 0xffffff, intensity: 1.2, sunHeight: 13, footprint: 0x555555, footprintSpecular: 0xffffff, grass: 0, bump: 0.08 },
  { name: "Green grass", ground: 0xd5f3bd, background: 0xb0c995, fog: 0.0175, ambient: 1.1, sun: 0xffffff, intensity: 2, sunHeight: 14, footprint: 0x286b35, footprintSpecular: 0x0b2010, grass: 1, bump: 0.055 },
  { name: "Golden grass", ground: 0xffebc9, background: 0xe0c58d, fog: 0.0175, ambient: 0.8, sun: 0xffe5b0, intensity: 2, sunHeight: 8, footprint: 0x67441c, footprintSpecular: 0xffffff, grass: 1, bump: 0.045 },
] as const;
