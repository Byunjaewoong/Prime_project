...
Snow-walker core/Smog.ts renders optional drifting ground mist in one transparent plane. The Smog checkbox only changes mesh visibility; toggling must not remount App or reset walking state.
